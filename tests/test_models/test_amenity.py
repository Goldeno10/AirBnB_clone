#!/usr/bin/python3
"""
Contains the Amenity test classes
"""
...
class TestAmenityDocs(unittest.TestCase):
    ...
    def test_pycodestyle_conformance(self):
        """Test that amenity.py conforms to pycodestyle style."""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        ...
        self.assertEqual(new_d["created_at"], inst.created_at.strftime(t_format))
        self.assertEqual(new_d["updated_at"], inst.updated_at.strftime(t_format))
